...
- **Persona Creation**: Design AI agents with unique personalities and knowledge areas
- **Chat Interface**: Engage in conversations with your personas
- **Persona Management**: Edit, duplicate, and delete personas
- **Explore Section**: Discover and use public personas
- **Basic Embedding**: Embed personas on websites
