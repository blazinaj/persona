...
import { User, Settings, Mail, Globe, Lock, Key, Camera, ExternalLink, Eye, EyeOff, Users, Star, Edit, Check, X, Loader2, AlertCircle, Save } from 'lucide-react';
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-2xl font-bold text-gray-900">
          {isOwnProfile ? 'Profile Settings' : `${profileData.display_name}'s Profile`}
        </h1>
        {isOwnProfile && (
          <Button variant="outline" leftIcon={<Settings size={16} />} onClick={() => navigate('/settings/billing')}>
            Account Settings
          </Button>
        )}
      </div>
      ...
      {/* Security Settings (only shown on own profile) */}
      {isOwnProfile && (
