/*
  # Fix RLS policies and add view tracking

  1. Changes
    - Drop and recreate persona_views policies with proper visibility checks
    - Add proper error handling for view tracking
    - Fix policy checks for persona visibility
