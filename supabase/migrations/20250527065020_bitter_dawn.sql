/*
  ...
  1. Changes
    - Drop existing function before recreating it with a different return type
    - Update column names to avoid ambiguity
    - Fix order to show messages in chronological order (ascending)
